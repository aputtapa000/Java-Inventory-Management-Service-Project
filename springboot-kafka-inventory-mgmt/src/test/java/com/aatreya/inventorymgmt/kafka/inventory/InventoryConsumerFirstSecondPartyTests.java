...
@SpringBootTest(
        classes = {InventoryConsumerFirstSecondParty.class, InventoryConsumerFirstSecondPartyTests.TestConfig.class},
        properties = "spring.cloud.azure.cosmos.enabled=true")
class InventoryConsumerFirstSecondPartyTests {

    @Autowired
    private InventoryConsumerFirstSecondParty consumer;
