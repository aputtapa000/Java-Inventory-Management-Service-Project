...
@SpringBootTest(
        classes = {InventoryConsumerStore.class, InventoryConsumerStoreTests.TestConfig.class},
        properties = "spring.cloud.azure.cosmos.enabled=true")
class InventoryConsumerStoreTests {

    @Autowired
    private InventoryConsumerStore consumer;
