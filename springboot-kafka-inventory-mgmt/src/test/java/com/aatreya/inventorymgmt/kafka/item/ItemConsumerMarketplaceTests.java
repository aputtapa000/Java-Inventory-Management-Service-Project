...
@SpringBootTest(
        classes = {ItemConsumerMarketplace.class, ItemConsumerMarketplaceTests.TestConfig.class},
        properties = "spring.cloud.azure.cosmos.enabled=true")
class ItemConsumerMarketplaceTests {

    @Autowired
    private ItemConsumerMarketplace consumer;
