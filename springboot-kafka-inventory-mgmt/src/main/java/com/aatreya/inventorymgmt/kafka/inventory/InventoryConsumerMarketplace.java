...
public class InventoryConsumerMarketplace {
    ...
    public InventoryConsumerMarketplace(InventoryRepository inventoryRepository) {
        this.inventoryRepository = inventoryRepository;
    }

    @KafkaListener(topics = "inventory-marketplace-topic", groupId = "inventory-marketplace-group", containerFactory = "inventoryKafkaListenerContainerFactory")
